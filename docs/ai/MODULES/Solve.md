...
Практическая деталь placement carve:
- у коннектора “carve” удаляет стены на центральной и боковых дорожках,
- пол коннектора на центральной дорожке удаляется для `k < X` (в `door cell` сохраняется),
- у комнаты “door cell” принудительно делается проходом (wall→floor).
